...
function Curl_360search($url, $header = [
...
function search_360() {
    // 执行 cURL 请求
    $jsonRes = json_decode(Curl_360search('https://ranks.hao.360.com/mbsug-api/hotnewsquery?type=news&realhot_limit=50', null, null), true);
